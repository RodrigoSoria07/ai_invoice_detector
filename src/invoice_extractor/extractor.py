...
returns a validated :class:`Invoice` or raises a controlled, typed error. It
runs fully offline — extract text locally, parse it with rules, validate.
"""
...
def extract_invoice(path: str | Path, extractor: TextExtractor | None = None) -> Invoice:
    ...
    Raises:
        ...
        ParsingError: the text could not be parsed into an Invoice (R6).
